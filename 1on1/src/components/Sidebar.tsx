    ...
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-light" style={{ width: "280px" }}>
            ...
            <div className="list-group list-group-flush my-3">
                <Link to="/dashboard" className={`list-group-item list-group-item-action bg-transparent  ${isActive('/dashboard') ? 'fw-bold' : ''}`}>
                    <i className="fas fa-tachometer-alt me-2"></i>My Calendars
                </Link>
                <Link to="/contacts" className={`list-group-item list-group-item-action bg-transparent mt-4 ${isActive('/contacts') ? 'fw-bold' : ''}`}>
